...
| 🖥️ | **桌面与浏览器自动化** | 键鼠/截屏/OCR/窗口控制 + Playwright 与反检测指纹浏览器；Nuphus/Playwright CLI/CloakBrowser 包体**随包预装开箱即用**，只有浏览器内核与 Python/Git/PowerShell 等工具链在「开发工具」按需下载（npmmirror/gh 国内加速，失败自动回落官方源；缺 Git 首启自动补装） |
