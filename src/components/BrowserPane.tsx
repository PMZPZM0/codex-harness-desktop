...
import { ArrowLeft, ArrowRight, ChevronDown, ExternalLink, Globe2, MoreHorizontal, Plus, RefreshCw, ShieldCheck, Star, X } from "lucide-react";
        ...
        <div className="browser-pane-menu-wrap">
          ...
          {menuOpen && <>
            ...
            <div className="browser-pane-menu" role="menu">
              <button role="menuitem" disabled={!active.url} onClick={() => { setMenuOpen(false); if (active.url) onOpenExternal?.(active.url); }}>
