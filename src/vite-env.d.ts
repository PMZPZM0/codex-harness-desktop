...
interface Window {
  codex: {
    ...
    channelsStatus(): Promise<{ weixin: boolean; telegram: boolean }>;
    ...
    relayAccounts(): Promise<{ id: string; baseUrl: string; email: string; loggedIn: boolean; selectedMode: "balance" | "plan" | null; selectedGroupId: number | null; selectedKeyName: string | null; active: boolean }[]>;
    ...
    openaiAccounts(): Promise<{ id: string; email: string; savedAt: number; active: boolean; planType: string; subscriptionUntil: string }[]>;
