...
bag.toggleAllGroups = toggleAllGroups as typeof bag.toggleAllGroups;
  ...
  const sidebarAllCollapsed = bag.viewTab === "groups" ? bag.allGroupsCollapsed : bag.allProjectsCollapsed;
bag.sidebarAllCollapsed = sidebarAllCollapsed as typeof bag.sidebarAllCollapsed;

  const toggleAllSidebarSections = bag.viewTab === "groups" ? bag.toggleAllGroups : bag.toggleAllProjects;
