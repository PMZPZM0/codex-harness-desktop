...
contextBridge.exposeInMainWorld("codex", {
  ...
  relayOverview: (id?: string) => ipcRenderer.invoke("relay:overview", id),
  relayCreateKey: (input: { name: string; groupId?: number | null; accountId?: string }) => ipcRenderer.invoke("relay:create-key", input),
